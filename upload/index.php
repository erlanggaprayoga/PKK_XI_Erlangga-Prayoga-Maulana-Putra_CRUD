        ...
        <div class="col-4">
            ...
            <form action="" method="post">
              <div class="masukan my-3">
                    ...
                    placeholder="Massukan Keyword pencarian!" autocomplete="off" class="form-control border border-success" style="width: 400px; border-radius: 40px;">
                </div>
        <div class="tombol my-3">
        <button class="btn btn-primary" type="submit" name="cari"style="border-radius: 40px";> Cari! 
        </button>
        </div>  
    </form>
        </div>
